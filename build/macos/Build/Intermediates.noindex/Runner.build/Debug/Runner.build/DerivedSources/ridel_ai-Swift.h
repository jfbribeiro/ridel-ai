...
#ifndef RIDEL_AI_SWIFT_H
#define RIDEL_AI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ridel_ai",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8ridel_ai11AppDelegate")
...
SWIFT_CLASS("_TtC8ridel_ai17MainFlutterWindow")
